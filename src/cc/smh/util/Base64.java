...
public class Base64 {
	...
	public static String encodeToString(byte[] bytes) {
		...
		return toString(encoded, PREFERRED_ENCODING);
	}
	...
	public static String decodeToString(String base64Encoded) {
		byte[] encodedBytes = toBytes(base64Encoded, PREFERRED_ENCODING);
	...
	public static String decodeToString(byte[] base64Encoded) {
		...
		return toString(decoded, PREFERRED_ENCODING);
	}
	...
	public static byte[] decode(String base64Encoded) {
		byte[] bytes = toBytes(base64Encoded, PREFERRED_ENCODING);
		return decode(bytes);
	}
